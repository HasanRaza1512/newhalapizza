...
import { drinkSizeOptions } from '../data/options'
    ...
    <motion.div variants={fadeUp} className="space-y-8 pb-4">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h4 className="text-xs font-black uppercase tracking-[0.2em] text-gray-400">Select Bottle Size</h4>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-6">
          ...
          <p className="text-[11px] font-medium text-gray-400">Add multiple drinks</p>
        </div>
      </div>
    </motion.div>
  )
