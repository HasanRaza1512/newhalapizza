    ...
    <section className="overflow-x-auto">
      <div className="flex min-w-max gap-3 pb-2 sm:gap-4">
        {cards.map((card) => {
          ...
          <div
            key={card.title}
            className={`group relative h-40 w-56 shrink-0 overflow-hidden rounded-3xl bg-gradient-to-br ${card.gradient} p-5 text-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl`}
          >
