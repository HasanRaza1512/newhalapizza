...
function StickyCategoryBar({ categories, activeCategory, onCategoryClick }) {
  ...
  return (
    <div className="sticky top-16 z-40 w-full border-b border-gray-100 bg-white/80 py-3 backdrop-blur-xl transition-all duration-300 sm:top-18 sm:py-3">
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-4 sm:px-6 lg:px-8">

        {/* Navigation Links - Responsive */}
        <nav className="flex flex-1 items-center gap-2 overflow-x-auto whitespace-nowrap scrollbar-hide sm:gap-3">
