        ...
        <nav className="flex flex-1 items-center gap-2 overflow-x-auto whitespace-nowrap no-scrollbar scroll-smooth pr-4 sm:gap-3">
          {categories.map((category) => (
            <button
              ...
              className={`shrink-0 rounded-full px-4 py-2 text-[12px] sm:text-[13px] font-black uppercase tracking-tight transition-all duration-300 ${activeCategory === category
